      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="text-2xl font-bold text-blue-400 mb-4">KLUG</div>
            <p className="text-gray-300 mb-6 leading-relaxed max-w-md">
              Leading manufacturer of hydraulic and pneumatic solutions. 
              We deliver precision-engineered components for industrial applications worldwide.
            </p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-gray-300">123 Industrial Ave</p>
                  <p className="text-gray-300">Manufacturing District</p>
              ...
              <div className="flex items-center">
                ...
                <p className="text-gray-300">info@klug.com</p>
              </div>
            </div>
          </div>
        </div>
